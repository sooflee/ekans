"""PL634_nih_r01_decel_short_xbi — NIH R01 Obligation Deceleration Proxy -> Short XBI vs IBB"""
import sys
...
def main():
    sid = "PL634_nih_r01_decel_short_xbi"
    tickers = ["XBI", "IBB", "SPY"]
    try:
    ...
    m = compute_metrics(pnl, benchmark=spy_r, name="NIH R01 Obligation Deceleration Proxy -> Short XBI vs IBB", positions=pos)
    save_result(sid, m, extra={
        "rule": "Use the same hardcoded annual NIH R01 new-award obligated $ table as PL615 (FY2015:5.4, FY2016:5.9, FY2017:6.3, FY2018:6.9, FY2019:7.3, FY2020:7.8, FY2021:8.5, FY2022:8.7, FY2023:8.9, FY2024:9.2). Com",
        "mechanism": "Use the same hardcoded annual NIH R01 new-award obligated $ table as PL615 (FY2015:5.4, FY2016:5.9, FY2017:6.3, FY2018:6.9, FY2019:7.3, FY2020:7.8, FY2021:8.5, FY2022:8.7, FY2023:8.9, FY2024:9.2). Compute YoY. FIRE SHORT XBI / LONG IBB pair when (a) prior-FY R01 YoY <= -2% (declining obligations) OR",
