...
def main():
    sid = "PL102_soybean_oil_ppi_food"
    ...
    # Load prices
    try:
        px = load_prices(['GIS', 'CPB', 'SPY'], start="1995-01-01")
    except Exception as e:
    ...
    m = compute_metrics(in_pos, benchmark=spy_ret, name="Soybean Oil PPI Spike -> Long GIS+CPB")
