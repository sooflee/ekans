"""PL131_oer_deceleration_tlt -- OER Deceleration -> Long TLT
Long TLT 126d when CUSR0000SEHC YoY decelerates >2pp from 6mo peak
"""
import sys
...
def main():
    sid = "PL131_oer_deceleration_tlt"
    ...
    # Load prices
    try:
        px = load_prices(['TLT', 'SPY'], start="1995-01-01")
    except Exception as e:
    ...
    m = compute_metrics(in_pos, benchmark=spy_ret, name="OER Deceleration -> Long TLT")
    rets_arr = [e["return"] for e in event_results]
    
    save_result(sid, m, extra={
        "rule": "Long TLT 126d when CUSR0000SEHC YoY decelerates >2pp from 6mo peak",
