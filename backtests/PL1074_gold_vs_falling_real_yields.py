"""PL1074_gold_vs_falling_real_yields Gold vs falling real yields (GLD/DFII10).

Gold's opportunity cost is the real yield; a falling real yield reverses the carry headwind.
"""
import sys
...
def main():
    sid = "PL1074_gold_vs_falling_real_yields"
    try:
    ...
    m = compute_metrics(pnl, benchmark=spy_bench, name='Gold vs falling real yields (GLD/DFII10)', positions=pos)
    save_result(sid, m, extra={
        "rule": '10y real yield (DFII10) falling (21d change < 0) -> long GLD, else flat.',
        "mechanism": "Gold's opportunity cost is the real yield; a falling real yield reverses the carry headwind.",
        "source": 'Gold / real-rate literature; FRED DFII10.',
