...
def main():
    sid = "PL104_wheat_ppi_collapse_restaurants"
    ...
    # Load prices
    try:
        px = load_prices(['DRI', 'MCD', 'SPY'], start="1995-01-01")
    except Exception as e:
    ...
    m = compute_metrics(in_pos, benchmark=spy_ret, name="Wheat PPI Collapse -> Long DRI+MCD")
